...
class GcsWhatsappConfig(models.Model):
    ...
    whatsapp_url = fields.Char(string='URL')
    whatsapp_api_secret = fields.Char(string='API Secret')
    whatsapp_api_key = fields.Char(string='API Key ')
    whatsapp_channel_id = fields.Char(string='Channel Id')
    whatsapp_phone_number = fields.Char(string='Phone Number')
    whatsapp_account_id = fields.Char(string='Account Id')
